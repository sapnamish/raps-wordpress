	...
	function onepress_custom_inline_style() {
		...
		?>
			...
			if ( $primary != '' ) { ?>
				...
				.btn-theme-primary-outline, .sidebar .widget a:hover, .section-services .service-item .service-image i,.section-clients .client-item .client-image i, .counter_item .counter__number,
